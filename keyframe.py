...
class Keyframe(object):
    ...
    def animate_step(self, person, persons, keyframe):
        ...
        self.add_loc_person(person, person.healthbar, person.x, person.y, person.z)  # add keyframe for location person
        self.add_loc_healthbar(person.healthbar, person.x, person.y, person.z + person.scale + 1)  # add keyframe for location healthbar
    ...
    def add_loc_person(self, person, healthbar, x, y, z):
    ...
    def add_loc_healthbar(self, healthbar, x, y, z):
    ...
    def add_swap(self, person, healthbar):
        ...
        self.add_loc_person(person, healthbar, swap_x, swap_y, person.z)
        self.add_loc_healthbar(healthbar, swap_x, swap_y, person.z + person.scale + 1)
